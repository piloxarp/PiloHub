...
BBC = [
	...
	{name:"Stretch&After",count:18,version:2.4},
...
### У раздела **Videos** появилась собственная иконка
 	`,version:4.2},
	{name:`
# - Новый Collection, Редизайн карточек, фиксы -
...
### Теперь функция NoImage запоминает была ли она включена.
 	`,version:4.3},
	{name:`
# - Каталог, оптимизация, Новый функци~~а~~онал -
### Немного именил размеры шрифтов, отступов и карточек на мобильных устройствах
### Небольшой редизайн табла информации в плеере
### В плеер была добавлена кнопка скачать
