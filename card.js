...
const coverOther = ["covers other/NCalicia.png","covers other/panchy.png","covers other/RimuruStrapon.png","covers other/tigress.png"];
...
const imgOther = document.querySelector("#imgOTHER");
...
function changeImages(frames) {
  ...
  imgOther.src = coverOther[frames];
